...
document.addEventListener("keydown", function (event) {
  ...
  if (event.metaKey && event.which === 18) {
...
function executeSearch(term) {
  ...
  if (results.length === 0) {
    ...
    //     console.log(curr);
    //     acc + '<li><a href="' + curr.permalink + '" tabindex="0">' + '<span class="title">' + curr.title + '</span><br /> <span class="sc">'
    //     + curr.section +'</span> — ' + curr.date + ' — <em>' + curr.desc + '</em></a></li>';
    // }
    var searchItems = results.slice(0, 5);
    // console.log(JSON.stringify(searchItems));
    for (let res in results.slice(0, 5)) {
